  ...
  [
    {
      id: 1,
      question:
        "React의 Virtual DOM(가상 DOM)에 대한 설명으로 가장 올바른 것은?",
      options: [
        {
          id: 1,
          label:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          id: 2,
          label:
            "state는 부모 컴포넌트에서 자식으로 전달되고, props는 컴포넌트 내부에서 자체적으로 관리됩니다.",
          answerBoolean: false,
        },
        {
          id: 3,
          label:
            "state와 props는 모두 컴포넌트 내부에서 자유롭게 수정할 수 있는 데이터입니다.",
          answerBoolean: false,
        },
      ],
      answerString:
      ...
      options: [
        {
          id: 1,
          label:
            "클래스 컴포넌트의 생명주기 메서드와 동일한 기능을 제공하기 위해 만들어졌습니다.",
          answerBoolean: true,
        },
        {
          id: 2,
          label:
            "함수형 컴포넌트에서 state와 생명주기 기능을 사용할 수 있게 해주는 함수입니다.",
          answerBoolean: false,
        },
        {
          id: 3,
          label:
            "반복문이나 조건문 안에서 호출될 수 없으며, 항상 컴포넌트의 최상위 레벨에서 호출되어야 합니다.",
          answerBoolean: false,
        },
      ],
      answerString:
    ...
    },
    {
      id: 4,
      question:
        "React에서 배열을 렌더링할 때 'key' prop을 사용하는 주된 이유는 무엇입니까?",
      options: [
        {
          id: 1,
          label:
            "Virtual DOM이 변경된 요소를 효율적으로 식별하고 업데이트하기 위함입니다.",
          answerBoolean: true,
        },
        {
          id: 2,
      ...
      options: [
        {
          id: 1,
          label:
            "폼(Form) 데이터의 상태 관리 주체가 React인지, 아니면 DOM 자신인지의 차이입니다.",
          answerBoolean: true,
        },
        {
          id: 2,
          label:
            "제어 컴포넌트는 함수형에서, 비제어 컴포넌트는 클래스형에서만 사용됩니다.",
          answerBoolean: false,
        },
        {
          id: 3,
          label:
            "성능 면에서 비제어 컴포넌트가 항상 제어 컴포넌트보다 우수합니다.",
          answerBoolean: false,
        },
      ],
      answerString:
      ...
      options: [
        {
          id: 1,
          label:
            "React.createElement()를 호출하는 코드로 변환되는 JavaScript의 구문 확장입니다.",
          answerBoolean: true,
        },
        {
          id: 2,
        ...
        },
        {
          id: 3,
          label:
            "JavaScript와 XML을 혼용해서 사용하기 위한 공식적인 웹 표준입니다.",
          answerBoolean: false,
        },
      ],
      answerString:
    ...
    },
    {
      id: 8,
      question:
        "React의 Context API는 주로 어떤 문제를 해결하기 위해 사용됩니까?",
      options: [
        {
          id: 1,
          label:
      ...
      options: [
        {
          id: 1,
          label:
            "컴포넌트의 props가 변경되지 않았을 때 불필요한 리렌더링을 방지하여 성능을 최적화합니다.",
          answerBoolean: true,
        },
        {
          id: 2,
        ...
        },
        {
          id: 3,
          label:
            "클래스형 컴포넌트를 함수형 컴포넌트처럼 사용할 수 있게 변환합니다.",
          answerBoolean: false,
        },
      ],
      answerString:
    ...
    },
    {
      id: 10,
      question:
        "React의 고차 컴포넌트(Higher-Order Component, HOC)에 대한 설명으로 올바른 것은?",
      options: [
        {
          id: 1,
          label:
        ...
        },
        {
          id: 2,
          label:
            "React Hooks를 대체하는 최신 기능으로, 더 이상 사용되지 않습니다.",
          answerBoolean: false,
        },
        {
          id: 3,
          label:
            "컴포넌트의 렌더링 순서를 결정하는 특별한 종류의 컴포넌트입니다.",
          answerBoolean: false,
        },
      ],
      answerString:
    ...
    },
    {
      id: 11,
      question:
        "함수형 컴포넌트와 클래스형 컴포넌트의 차이점으로 가장 올바른 것은?",
      options: [
        {
          id: 1,
          label:
        ...
        },
        {
          id: 2,
          label:
            "함수형 컴포넌트는 state를 사용할 수 없고, 클래스형 컴포넌트만 state를 관리할 수 있습니다.",
          answerBoolean: false,
        },
        {
          id: 3,
          label:
            "클래스형 컴포넌트가 함수형 컴포넌트보다 항상 성능이 우수합니다.",
          answerBoolean: false,
        },
      ],
      answerString:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          id: 2,
          label:
            "클래스형 컴포넌트의 this.setState()와 완전히 동일한 방식으로 동작합니다.",
          answerBoolean: false,
        },
        {
          id: 3,
          label:
            "상태 업데이트 시 이전 상태와 새로운 상태를 자동으로 병합(merge)합니다.",
          answerBoolean: false,
        },
      ],
      answerString:
      ...
      options: [
        {
          id: 1,
          label:
            "useMemo는 계산된 값을 메모이제이션하고, useCallback은 함수를 메모이제이션합니다.",
          answerBoolean: true,
        },
        {
          id: 2,
          label:
            "useMemo는 함수를 메모이제이션하고, useCallback은 계산된 값을 메모이제이션합니다.",
          answerBoolean: false,
        },
        {
          id: 3,
      ...
      options: [
        {
          id: 1,
          label:
            "복잡한 상태 로직을 관리하고, 여러 하위 값들을 포함하는 상태 객체를 다룰 때 useState보다 적합합니다.",
          answerBoolean: true,
        },
        {
          id: 2,
          label:
            "컴포넌트의 렌더링 횟수를 줄여 성능을 최적화하기 위해 사용합니다.",
          answerBoolean: false,
        },
        {
          id: 3,
      ...
      options: [
        {
          id: 1,
          label:
            "DOM 요소에 직접 접근하거나, 렌더링 사이에 변경되지 않는 값을 저장하기 위해 사용합니다.",
          answerBoolean: true,
        },
        {
          id: 2,
          label:
            "컴포넌트의 상태를 관리하고, 상태 변경 시 리렌더링을 트리거하기 위해 사용합니다.",
          answerBoolean: false,
        },
        {
          id: 3,
          label:
            "다른 컴포넌트의 props에 접근하기 위해 사용하는 참조 Hook입니다.",
          answerBoolean: false,
        },
      ],
      answerString:
      ...
      options: [
        {
          id: 1,
          label:
            "여러 JSX 요소를 하나의 부모 요소로 감쌀 때, 불필요한 DOM 노드를 추가하지 않기 위해 사용합니다.",
          answerBoolean: true,
        },
        {
          id: 2,
          label:
            "컴포넌트의 성능을 최적화하고 렌더링 속도를 높이기 위해 사용합니다.",
          answerBoolean: false,
        },
        {
          id: 3,
      ...
      options: [
        {
          id: 1,
          label:
            "하위 컴포넌트 트리에서 발생한 JavaScript 에러를 잡아내고, 대체 UI를 보여주는 React 컴포넌트입니다.",
          answerBoolean: true,
        },
        {
          id: 2,
        ...
        },
        {
          id: 3,
          label:
            "이벤트 핸들러와 비동기 코드에서 발생하는 모든 에러를 처리할 수 있습니다.",
          answerBoolean: false,
        },
      ],
      answerString:
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          id: 2,
          label:
            "컴포넌트의 상태 업데이트를 지연시켜 성능을 최적화하는 기능입니다.",
          answerBoolean: false,
        },
        {
          id: 3,
      ...
      options: [
        {
          id: 1,
          label:
            "컴포넌트 로직을 재사용 가능한 함수로 추출한 것으로, 함수명이 'use'로 시작해야 합니다.",
          answerBoolean: true,
        },
        {
          id: 2,
      ...
      options: [
        {
          id: 1,
          label:
            "부모 컴포넌트의 DOM 계층 구조 밖에 있는 DOM 노드로 자식을 렌더링할 수 있게 해주는 기능입니다.",
          answerBoolean: true,
        },
        {
          id: 2,
        ...
        },
        {
          id: 3,
          label:
            "서버와 클라이언트 간의 데이터 동기화를 위한 React 기능입니다.",
          answerBoolean: false,
        },
      ],
      answerString:
      ...
      options: [
        {
          id: 1,
          label:
            "브라우저의 네이티브 이벤트를 감싸서 크로스 브라우저 호환성을 제공하는 React의 이벤트 시스템입니다.",
          answerBoolean: true,
        },
        {
          id: 2,
      ...
      options: [
        {
          id: 1,
          label:
            "개발 모드에서 안전하지 않은 생명주기 메서드나 잠재적 문제를 가진 코드를 감지하고 경고를 표시합니다.",
          answerBoolean: true,
        },
        {
          id: 2,
        ...
        },
        {
          id: 3,
          label:
            "TypeScript와의 호환성을 강화하고 타입 체킹을 엄격하게 수행합니다.",
          answerBoolean: false,
        },
      ],
      answerString:
    ...
    },
    {
      id: 23,
      question:
        "React의 Concurrent Features(동시성 기능)에 대한 설명으로 올바른 것은?",
      options: [
        {
          id: 1,
          label:
        ...
        },
        {
          id: 2,
          label:
            "여러 컴포넌트를 동시에 병렬로 렌더링하여 성능을 향상시키는 기능입니다.",
          answerBoolean: false,
        },
        {
          id: 3,
          label:
            "서버와 클라이언트에서 동시에 실행되는 코드를 작성할 수 있게 해주는 기능입니다.",
          answerBoolean: false,
        },
      ],
      answerString:
