...
export const TYPESCRIPT_MULTIPLE_CHOICE_QUESTIONS: MultipleChoiceQuestion[] = [
  {
    id: 1,
    ...
    options: [
      ...
      {
        id: 2,
        label: "`unknown`은 모든 타입을 허용하고, `any`는 특정 타입만 허용한다",
        answerBoolean: false,
      },
      {
        id: 3,
  ...
  },
  {
    ...
    options: [
      {
        id: 1,
        label: "타입 T의 모든 프로퍼티를 선택적(optional)으로 만드는 타입이다",
        answerBoolean: true,
      },
      {
        id: 2,
  ...
  {
    id: 5,
    question: "TypeScript의 타입 가드(Type Guard)에 대한 설명으로 올바른 것은?",
    options: [
      {
        id: 1,
        label:
  ...
  },
  {
    ...
    options: [
      {
        id: 1,
        label: "객체 타입의 모든 키를 유니온 타입으로 추출하는 타입 연산자이다",
        answerBoolean: true,
      },
      {
        id: 2,
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 2,
        label: "JavaScript의 typeof와 동일하게 런타임에 타입 문자열을 반환한다",
        answerBoolean: false,
      },
      {
        id: 3,
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 2,
        label: "모든 변수를 null로 초기화하도록 강제하는 엄격한 코딩 규칙이다",
        answerBoolean: false,
      },
      {
        id: 3,
  ...
  },
  {
    ...
    options: [
      {
        id: 1,
        label: "`A | B` 형태로 여러 타입 중 하나일 수 있음을 나타내는 타입이다",
        answerBoolean: true,
      },
      {
        id: 2,
